...
- Relational databases are places to store data. SQL is a standard language used to manage databases. SQL is how we interact with a database.

- [ ] Why do tables need a `primary key`?
- The primary key insures that every row in that table is unique.
...
- A third table is used to link the two tables together.
